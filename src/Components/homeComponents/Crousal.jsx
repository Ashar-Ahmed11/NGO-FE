...
import coverImage from '../../Images/car.png'
      ...
      >
        ...
        <div
          style={{
            ...
            right: 0,
            bottom: 0,
            backgroundColor: 'rgba(151, 55, 31, 0.6)',
            zIndex: 1,
          }}
        />
        ...
        <div className="row w-100 position-relative" style={{ zIndex: 2 }}>
          ...
          <div className="col-md-6 d-flex justify-content-center align-items-center my-3">
            ...
            >
              ...
              <Link 
                className="start-application-btn text-decoration-none" 
                to="loan-form" 
                role="button"
              >
           ...
           {   siteData && <div className="d-flex flex-wrap gap-3 justify-content-center">
                {/* YouTube Button */}
                <a
  href={siteData.ytLink}
  target="_blank"
  rel="noopener noreferrer"
  style={{ textDecoration: "none" }}
>
                <button className="btn d-flex align-items-center gap-2 px-3 py-2 youtube-btn">
  ...
  style={{ textDecoration: "none" }}
>
                <button className="btn d-flex align-items-center gap-2 px-3 py-2 facebook-btn" >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
